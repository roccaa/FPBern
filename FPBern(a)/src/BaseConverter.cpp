...
//	cout << "BaseConverter::BaseConverter\n";
	this->vars = vars;
...
//		cout << i <<"th BC is : :" << bern_coeffs[i] << endl;
	}
...
vector< vector<ex> > BaseConverter::matrixProd(vector< vector<ex> > A, vector< vector<ex> > B){
	...
	//cout << "BaseConverter::matrixProd ----> Done!\n";
	//cout << "plot product matrix !\n";
...
vector< int > BaseConverter::transp( vector<int> b, vector<int> degs, int degs_prod ){
	...
	//cout << "BaseConverter::transp (coordinate)\n";
	//cout << "b = " << b;
	//cout << "degs = " << degs;
	//cout << "degs_prod = " << degs_prod << endl;
	vector< int > b_transp(2,0);
	//cout << "b_transp = " << b_transp << endl;
	b_transp[0] = b[1] % degs[1]; // degs[1] must exist !!  what is degs ?!
	...
	for(int i=0; i<M.size(); i++){
		for(int j=0; j<M[i].size(); j++){
			if(M[i][j] != 0){
				...
				//cout << "Assignation phase\n";
				//cout << "M.size() = " << M.size() << endl;
				//cout << "place1 = " << ij_t[0] << endl;
				//cout << "M["<<i<<"].size() = " << M[i].size() << endl;
				//cout << "place2 = " << ij_t[1] << endl;
...
//	cout <<  "BaseConverter::transp\n ---> Done\n";
//	cout << "plot M_transp matrix !\n";
//	for(int i=0; i<M_transp.size(); i++)
//	{
//		cout << "[ ";
//		for(int j=0; j<M_transp[i].size(); j++)
//		{
//			cout << M_transp[i][j] << ", ";
//		}
//		cout << " ]\n";
